...
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| 14-webpack   | SUPPORTED — `app-build-manifest.json.pages`                                                                                                                   | SUPPORTED — `build-manifest.json.pages['/_app'] ∪ build-manifest.json.pages[route]` | SUPPORTED — pages via `pages['/_app'] ∪ pages[route]`, app via `app-build-manifest.json.pages`         |
...
```json
{
  "pages": {
    "/_not-found/page": [
      ...
      "static/chunks/main-app-141e59e4b0610136.js",
    ...
    "/blog/[slug]/page": [
      ...
      "static/chunks/945-67e69556dfc1e382.js",
      "static/chunks/main-app-141e59e4b0610136.js",
      "static/chunks/app/blog/[slug]/page-6806b9b6fc39b72a.js"
    ],
    "/(marketing)/about/page": [
      ...
      "static/chunks/945-67e69556dfc1e382.js",
      "static/chunks/main-app-141e59e4b0610136.js",
      "static/chunks/app/(marketing)/about/page-8806a08809c7a55d.js"
    ],
    "/page": [
      "static/chunks/webpack-100b9e646d9c912e.js",
      "static/chunks/2200cc46-8888eb43b3e410d8.js",
      "static/chunks/945-67e69556dfc1e382.js",
      "static/chunks/main-app-141e59e4b0610136.js",
      "static/chunks/app/page-dc144e131440ec81.js"
    ]
  }
}
```
...
| -------------- | ------------------: | -------------------------: | ----: | -------------------------------------------------------- |
| `/`            |             87.5 kB |                    87.5 kB |  -4 B | Within Next's ±50 B print-rounding window for `87.5 kB`. |
| `/_not-found`  |             88.1 kB |                    88.1 kB | -39 B | Within Next's ±50 B print-rounding window for `88.1 kB`. |
| `/about`       |             89.0 kB |                      89 kB | +17 B | Within Next's ±500 B print-rounding window for `89 kB`.  |
| `/blog/[slug]` |             88.8 kB |                    88.8 kB | +28 B | Within Next's ±50 B print-rounding window for `88.8 kB`. |
...
```json
{
  "pages": {
    "/_app": [
      ...
      "static/chunks/pages/_app-748a1c79e0ab11b1.js"
    ],
    "/": [
      "static/chunks/webpack-4e7214a60fad8e88.js",
      "static/chunks/framework-0cbe3b56a5f66701.js",
...
| Route          | Computed gzip bytes | `next build` printed value | Delta | Explanation                                              |
| -------------- | ------------------: | -------------------------: | ----: | -------------------------------------------------------- |
| `/`            |             80.6 kB |                    80.6 kB |  -1 B | Within Next's ±50 B print-rounding window for `80.6 kB`. |
| `/about`       |             82.2 kB |                    82.2 kB | +38 B | Within Next's ±50 B print-rounding window for `82.2 kB`. |
| `/blog/[slug]` |             82.1 kB |                    82.1 kB | +35 B | Within Next's ±50 B print-rounding window for `82.1 kB`. |
...
```json
{
  "pages": {
    "/_not-found/page": [
      ...
      "static/chunks/main-app-eac8bf00b6dfef7e.js",
    ...
    "/(marketing)/about/page": [
      ...
      "static/chunks/945-25bcc0729128f665.js",
      "static/chunks/main-app-eac8bf00b6dfef7e.js",
      "static/chunks/app/(marketing)/about/page-3e2bf6e7f72644c1.js"
    ],
    "/page": [
      "static/chunks/webpack-100b9e646d9c912e.js",
      "static/chunks/2200cc46-8888eb43b3e410d8.js",
    ...
    "/products/[slug]/page": [
      ...
      "static/chunks/945-25bcc0729128f665.js",
      "static/chunks/main-app-eac8bf00b6dfef7e.js",
      "static/chunks/app/products/[slug]/page-054d9a8fa405d6eb.js"
    ]
  }
}
```
...
| Route                 | Computed gzip bytes | `next build` printed value | Delta | Explanation                                              |
| --------------------- | ------------------: | -------------------------: | ----: | -------------------------------------------------------- |
| `/legacy`             |             81.0 kB |                      81 kB | +19 B | Within Next's ±500 B print-rounding window for `81 kB`.  |
| `/legacy/about`       |             83.0 kB |                      83 kB | -46 B | Within Next's ±500 B print-rounding window for `83 kB`.  |
| `/legacy/blog/[slug]` |             82.5 kB |                    82.5 kB | +37 B | Within Next's ±50 B print-rounding window for `82.5 kB`. |
| `/`                   |             87.3 kB |                    87.3 kB | +26 B | Within Next's ±50 B print-rounding window for `87.3 kB`. |
| `/_not-found`         |             88.1 kB |                    88.1 kB | -39 B | Within Next's ±50 B print-rounding window for `88.1 kB`. |
| `/about`              |             89.2 kB |                    89.2 kB | -12 B | Within Next's ±50 B print-rounding window for `89.2 kB`. |
| `/products/[slug]`    |             88.9 kB |                    88.9 kB | +40 B | Within Next's ±50 B print-rounding window for `88.9 kB`. |
